...
def main():
    ...
    L.append("1. composite 现由【赚钱效应(结算宇宙breadth)+涨停强度+两融变化+人气热度】等权合成。"
             "**人气热度**已由 hot_rank_detail 每股历史补齐(纳入后顶部06-30升至第91百分位,识别力改善);"
             "**散户资金净流向**(个股资金流走push2his,海外/沙盒代理墙)与**板块资金流历史**仍缺位,"
             "需国内出口本地跑 backfill_retail_hist.py 补齐,补齐后顶部识别力应再提升。")
